    ...
    override fun doIt(): String {
        ...
        if (p_CopyOverwriteAcct) {
            sql = StringBuilder("UPDATE M_Product_Category_Acct pa ")
                ...
                .append(acct.p_Revenue_Acct)
                .append(", P_Expense_Acct=")
                .append(acct.p_Expense_Acct)
                .append(", P_CostAdjustment_Acct=")
                .append(acct.p_CostAdjustment_Acct)
                .append(", P_InventoryClearing_Acct=")
                .append(acct.p_InventoryClearing_Acct)
                .append(", P_Asset_Acct=")
                .append(acct.p_Asset_Acct)
                .append(", P_COGS_Acct=")
                .append(acct.p_COGS_Acct)
                .append(", P_PurchasePriceVariance_Acct=")
                .append(acct.p_PurchasePriceVariance_Acct)
                .append(", P_InvoicePriceVariance_Acct=")
                .append(acct.p_InvoicePriceVariance_Acct)
                .append(", P_AverageCostVariance_Acct=")
                .append(acct.p_AverageCostVariance_Acct)
                .append(", P_TradeDiscountRec_Acct=")
                .append(acct.p_TradeDiscountRec_Acct)
                .append(", P_TradeDiscountGrant_Acct=")
                .append(acct.p_TradeDiscountGrant_Acct)
                .append(", P_RateVariance_Acct=")
                .append(acct.p_RateVariance_Acct)
                .append(", P_LandedCostClearing_Acct=")
                .append(acct.p_LandedCostClearing_Acct)
        ...
        if (p_CopyOverwriteAcct) {
            sql = StringBuilder("UPDATE C_BP_Group_Acct a ")
                ...
                .append(acct.c_Receivable_Acct)
                .append(", C_Receivable_Services_Acct=")
                .append(acct.c_Receivable_Services_Acct)
                .append(", C_Prepayment_Acct=")
                .append(acct.c_Prepayment_Acct)
                .append(", V_Liability_Acct=")
                .append(acct.v_Liability_Acct)
                .append(", V_Liability_Services_Acct=")
                .append(acct.v_Liability_Services_Acct)
                .append(", V_Prepayment_Acct=")
                .append(acct.v_Prepayment_Acct)
                .append(", PayDiscount_Exp_Acct=")
                .append(acct.payDiscount_Exp_Acct)
                .append(", PayDiscount_Rev_Acct=")
                .append(acct.payDiscount_Rev_Acct)
                .append(", WriteOff_Acct=")
                .append(acct.writeOff_Acct)
                .append(", NotInvoicedReceipts_Acct=")
                .append(acct.notInvoicedReceipts_Acct)
                .append(", UnEarnedRevenue_Acct=")
                .append(acct.unEarnedRevenue_Acct)
                .append(", Updated=SysDate, UpdatedBy=0 ")
    ...
    */
        ...
        if (p_CopyOverwriteAcct) {
            sql = StringBuilder("UPDATE C_Tax_Acct a ")
                ...
                .append(acct.t_Due_Acct)
                .append(", T_Credit_Acct=")
                .append(acct.t_Credit_Acct)
                .append(", T_Expense_Acct=")
                .append(acct.t_Expense_Acct)
                .append(", Updated=SysDate, UpdatedBy=0 ")
                .append("WHERE a.C_AcctSchema_ID=")
                .append(p_C_AcctSchema_ID)
        ...
        if (p_CopyOverwriteAcct) {
            sql = StringBuilder("UPDATE C_BankAccount_Acct a ")
                ...
                .append(acct.b_InTransit_Acct)
                .append(", B_Asset_Acct=")
                .append(acct.b_Asset_Acct)
                .append(", B_InterestRev_Acct=")
                .append(acct.b_InterestRev_Acct)
                .append(", B_InterestExp_Acct=")
                .append(acct.b_InterestExp_Acct)
                .append(", B_UnallocatedCash_Acct=")
                .append(acct.b_UnallocatedCash_Acct)
                .append(", B_PaymentSelect_Acct=")
                .append(acct.b_PaymentSelect_Acct)
                .append(", Updated=SysDate, UpdatedBy=0 ")
                .append("WHERE a.C_AcctSchema_ID=")
                .append(p_C_AcctSchema_ID)
    ...
    */
        ...
        if (p_CopyOverwriteAcct) {
            sql = StringBuilder("UPDATE C_Cashbook_Acct a ")
                ...
                .append(acct.cB_Asset_Acct)
                .append(", CB_Differences_Acct=")
                .append(acct.cB_Differences_Acct)
                .append(", CB_CashTransfer_Acct=")
                .append(acct.cB_CashTransfer_Acct)
                .append(", CB_Expense_Acct=")
                .append(acct.cB_Expense_Acct)
                .append(", CB_Receipt_Acct=")
                .append(acct.cB_Receipt_Acct)
                .append(", Updated=SysDate, UpdatedBy=0 ")
                .append("WHERE a.C_AcctSchema_ID=")
                .append(p_C_AcctSchema_ID)

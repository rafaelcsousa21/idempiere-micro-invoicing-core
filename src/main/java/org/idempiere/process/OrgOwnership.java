...
public class OrgOwnership extends SvrProcess {
    ...
    private String warehouseOwnership() {
        ...
        addLog(0, null, new BigDecimal(no), MsgKt.translate("M_Warehouse_ID"));
        ...
        addLog(0, null, new BigDecimal(no), MsgKt.translate("C_AcctSchema_ID"));
        ...
        sql.append("UPDATE M_Locator ")
                ...
                .append(p_AD_Org_ID);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("M_Locator_ID"));
        ...
        sql.append("UPDATE M_StorageOnHand	 s ")
                ...
                .append(p_AD_Org_ID);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("Storage"));
        ...
        sql.append("UPDATE M_StorageReservation	 s ")
                ...
                .append(p_AD_Org_ID);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("StorageReservation"));
    ...
    private String productOwnership() {
        if (log.isLoggable(Level.INFO))
            log.info(
                    "productOwnership - M_Product_Category_ID="
        ...
        int no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("M_Product_ID"));
        ...
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("M_Product_BOM_ID"));

        //	PO
        sql = new StringBuilder("UPDATE M_Product_PO x ").append(set);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("PO"));

        //	Trl
        sql = new StringBuilder("UPDATE M_Product_Trl x ").append(set);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("AD_Language"));
    ...
    private String bPartnerOwnership() {
        if (log.isLoggable(Level.INFO))
            log.info(
                    "bPartnerOwnership - C_BP_Group_ID="
                            + p_C_BP_Group_ID
                            + ", C_BPartner_ID="
                            + p_C_BPartner_ID);
        ...
        int no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("C_BPartner_ID"));
        ...
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("C_BPartner_Location_ID"));

        //	Contcat/User
        sql = new StringBuilder("UPDATE AD_User x ").append(set);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("AD_User_ID"));

        //	BankAcct
        sql = new StringBuilder("UPDATE C_BP_BankAccount x ").append(set);
        no = executeUpdate(sql.toString());
        addLog(0, null, new BigDecimal(no), MsgKt.translate("C_BP_BankAccount_ID"));

...
public class X_I_Conversion_Rate extends PO implements I_I_Conversion_Rate, I_Persistent {
  ...
  public org.compiere.model.I_C_Conversion_Rate getC_Conversion_Rate() throws RuntimeException {
    return (org.compiere.model.I_C_Conversion_Rate)
        MTable.get(getCtx(), org.compiere.model.I_C_Conversion_Rate.Table_Name)
            .getPO(getC_Conversion_Rate_ID(), null);
  }
  ...
  public void setI_Conversion_Rate_ID(int I_Conversion_Rate_ID) {
    if (I_Conversion_Rate_ID < 1) set_ValueNoCheck(COLUMNNAME_I_Conversion_Rate_ID, null);
    else set_ValueNoCheck(COLUMNNAME_I_Conversion_Rate_ID, Integer.valueOf(I_Conversion_Rate_ID));
  }

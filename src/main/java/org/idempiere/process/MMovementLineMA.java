...
public class MMovementLineMA extends X_M_MovementLineMA {
    ...
    public String toString() {
        return "MMovementLineMA[" + "M_MovementLine_ID=" +
                getMovementLineId() +

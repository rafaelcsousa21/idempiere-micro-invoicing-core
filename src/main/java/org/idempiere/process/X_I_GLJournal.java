...
public class X_I_GLJournal extends PO implements I_I_GLJournal, I_Persistent {
  ...
  public void setAD_OrgDoc_ID(int AD_OrgDoc_ID) {
    if (AD_OrgDoc_ID < 1) set_Value(COLUMNNAME_AD_OrgDoc_ID, null);
    else set_Value(COLUMNNAME_AD_OrgDoc_ID, Integer.valueOf(AD_OrgDoc_ID));
  }
  ...
  public org.compiere.model.I_GL_JournalLine getGL_JournalLine() throws RuntimeException {
    return (org.compiere.model.I_GL_JournalLine)
        MTable.get(getCtx(), org.compiere.model.I_GL_JournalLine.Table_Name)
            .getPO(getGL_JournalLine_ID(), null);
  }
  ...
  public void setI_GLJournal_ID(int I_GLJournal_ID) {
    if (I_GLJournal_ID < 1) set_ValueNoCheck(COLUMNNAME_I_GLJournal_ID, null);
    else set_ValueNoCheck(COLUMNNAME_I_GLJournal_ID, Integer.valueOf(I_GLJournal_ID));
  }

...
public class ReplenishReportProduction extends SvrProcess {
    ...
    private void createProduction() {
        ...
        for (X_T_Replenish replenish : replenishs) {
            ...
            for (MReplenish rep :
                    MReplenish.getForProduct(replenish.getProductId())) {
            ...
            while (qtyToProduce.compareTo(Env.ZERO) > 0) {
                ...
                production.setMovementDate(Env.getContextAsDate());
                production.saveEx();
    ...
    private X_T_Replenish[] getReplenish(String where) {
        return BaseReplenishReportProductionKt.getReplenish(where, getProcessInstanceId());
    } //	getReplenish
} //	Replenish

...
public class AcctSchemaDefaultCopy extends SvrProcess {
  ...
  protected String doIt() throws Exception {
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE M_Product_Category_Acct pa ")
              .append("SET P_Revenue_Acct=")
              .append(acct.getP_Revenue_Acct())
              .append(", P_Expense_Acct=")
              .append(acct.getP_Expense_Acct())
              .append(", P_CostAdjustment_Acct=")
              .append(acct.getP_CostAdjustment_Acct())
              .append(", P_InventoryClearing_Acct=")
              .append(acct.getP_InventoryClearing_Acct())
              .append(", P_Asset_Acct=")
              .append(acct.getP_Asset_Acct())
              .append(", P_COGS_Acct=")
              .append(acct.getP_COGS_Acct())
              .append(", P_PurchasePriceVariance_Acct=")
              .append(acct.getP_PurchasePriceVariance_Acct())
              .append(", P_InvoicePriceVariance_Acct=")
              .append(acct.getP_InvoicePriceVariance_Acct())
              .append(", P_AverageCostVariance_Acct=")
              .append(acct.getP_AverageCostVariance_Acct())
              .append(", P_TradeDiscountRec_Acct=")
              .append(acct.getP_TradeDiscountRec_Acct())
              .append(", P_TradeDiscountGrant_Acct=")
              .append(acct.getP_TradeDiscountGrant_Acct())
              .append(", P_RateVariance_Acct=")
              .append(acct.getP_RateVariance_Acct())
              .append(", P_LandedCostClearing_Acct=")
              .append(acct.getP_LandedCostClearing_Acct())
    ...
    sql =
        new StringBuilder("INSERT INTO M_Product_Category_Acct ")
            ...
            .append(" INNER JOIN C_AcctSchema_Default acct ON (p.AD_Client_ID=acct.clientId) ")
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE C_BP_Group_Acct a ")
              .append("SET C_Receivable_Acct=")
              .append(acct.getC_Receivable_Acct())
              .append(", C_Receivable_Services_Acct=")
              .append(acct.getC_Receivable_Services_Acct())
              .append(", C_Prepayment_Acct=")
              .append(acct.getC_Prepayment_Acct())
              .append(", V_Liability_Acct=")
              .append(acct.getV_Liability_Acct())
              .append(", V_Liability_Services_Acct=")
              .append(acct.getV_Liability_Services_Acct())
              .append(", V_Prepayment_Acct=")
              .append(acct.getV_Prepayment_Acct())
              .append(", PayDiscount_Exp_Acct=")
              .append(acct.getPayDiscount_Exp_Acct())
              .append(", PayDiscount_Rev_Acct=")
              .append(acct.getPayDiscount_Rev_Acct())
              .append(", WriteOff_Acct=")
              .append(acct.getWriteOff_Acct())
              .append(", NotInvoicedReceipts_Acct=")
              .append(acct.getNotInvoicedReceipts_Acct())
              .append(", UnEarnedRevenue_Acct=")
              .append(acct.getUnEarnedRevenue_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
    ...
    */
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE M_Warehouse_Acct a ")
              .append("SET W_Differences_Acct=")
              .append(acct.getW_Differences_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
              .append("WHERE a.C_AcctSchema_ID=")
              .append(p_C_AcctSchema_ID)
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE C_Project_Acct a ")
              .append("SET PJ_Asset_Acct=")
              .append(acct.getPJ_Asset_Acct())
              .append(", PJ_WIP_Acct=")
              .append(acct.getPJ_Asset_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
              .append("WHERE a.C_AcctSchema_ID=")
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE C_Tax_Acct a ")
              .append("SET T_Due_Acct=")
              .append(acct.getT_Due_Acct())
              .append(", T_Credit_Acct=")
              .append(acct.getT_Credit_Acct())
              .append(", T_Expense_Acct=")
              .append(acct.getT_Expense_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
              .append("WHERE a.C_AcctSchema_ID=")
              .append(p_C_AcctSchema_ID)
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE C_BankAccount_Acct a ")
              .append("SET B_InTransit_Acct=")
              .append(acct.getB_InTransit_Acct())
              .append(", B_Asset_Acct=")
              .append(acct.getB_Asset_Acct())
              .append(", B_InterestRev_Acct=")
              .append(acct.getB_InterestRev_Acct())
              .append(", B_InterestExp_Acct=")
              .append(acct.getB_InterestExp_Acct())
              .append(", B_UnallocatedCash_Acct=")
              .append(acct.getB_UnallocatedCash_Acct())
              .append(", B_PaymentSelect_Acct=")
              .append(acct.getB_PaymentSelect_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
              .append("WHERE a.C_AcctSchema_ID=")
              .append(p_C_AcctSchema_ID)
    ...
    */
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE C_Charge_Acct a ")
              .append("SET Ch_Expense_Acct=")
              .append(acct.getCh_Expense_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
              .append("WHERE a.C_AcctSchema_ID=")
              .append(p_C_AcctSchema_ID)
    ...
    if (p_CopyOverwriteAcct) {
      sql =
          new StringBuilder("UPDATE C_Cashbook_Acct a ")
              .append("SET CB_Asset_Acct=")
              .append(acct.getCB_Asset_Acct())
              .append(", CB_Differences_Acct=")
              .append(acct.getCB_Differences_Acct())
              .append(", CB_CashTransfer_Acct=")
              .append(acct.getCB_CashTransfer_Acct())
              .append(", CB_Expense_Acct=")
              .append(acct.getCB_Expense_Acct())
              .append(", CB_Receipt_Acct=")
              .append(acct.getCB_Receipt_Acct())
              .append(", Updated=SysDate, UpdatedBy=0 ")
              .append("WHERE a.C_AcctSchema_ID=")
              .append(p_C_AcctSchema_ID)

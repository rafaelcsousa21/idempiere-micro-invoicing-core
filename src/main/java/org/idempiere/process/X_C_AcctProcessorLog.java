...
public class X_C_AcctProcessorLog extends PO implements I_C_AcctProcessorLog, I_Persistent {
  ...
  public void setC_AcctProcessorLog_ID(int C_AcctProcessorLog_ID) {
    if (C_AcctProcessorLog_ID < 1) set_ValueNoCheck(COLUMNNAME_C_AcctProcessorLog_ID, null);
    else set_ValueNoCheck(COLUMNNAME_C_AcctProcessorLog_ID, Integer.valueOf(C_AcctProcessorLog_ID));
  }

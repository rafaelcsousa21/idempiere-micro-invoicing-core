 ...
 * 95054, USA * or via info@compiere.org or http://www.compiere.org/license.html * * Copyright (C)
 * 2005 Robert KLEIN. robeklein@gmail.com * Contributor(s): ______________________________________.
 * * ***************************************************************************
 */
    ...
    protected String doIt() throws Exception {
        ...
        for (int i = 0; i < tables.length; i++) {
            ...
            sql.append("SELECT ")
                    ...
                    .append(m_AD_Org_ID)
                    .append(", SYSDATE, ")
                    .append(Env.getUserId(Env.getCtx()))
                    .append(", SYSDATE, ")
                    .append(Env.getUserId(Env.getCtx()))
                    .append(", ")
                    .append(m_AD_Role_ID_To)

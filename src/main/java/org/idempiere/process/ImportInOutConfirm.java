...
public class ImportInOutConfirm extends SvrProcess {
  ...
  protected String doIt() throws Exception {
    StringBuilder msglog =
        new StringBuilder("I_InOutLineConfirm_ID=").append(p_I_InOutLineConfirm_ID);
    ...
    sql =
        new StringBuilder("UPDATE I_InOutLineConfirm ")
    ...
    ResultSet rs = null;
    sql =
        new StringBuilder("SELECT * FROM I_InOutLineConfirm ")

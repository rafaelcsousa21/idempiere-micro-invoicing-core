...
public class ProductCategoryAcctCopy extends SvrProcess {
    ...
    protected void prepare() {
        ...
        for (IProcessInfoParameter iProcessInfoParameter : para) {
            ...
            else if (name.equals("C_AcctSchema_ID")) p_C_AcctSchema_ID = iProcessInfoParameter.getParameterAsInt();
    ...
    protected String doIt() throws Exception {
        ...
        //	Update
        StringBuilder sql =
                new StringBuilder("UPDATE M_Product_Acct pa ")
                        .append(
                        ...
                        .append(" WHERE pca.M_Product_Category_ID=")
                        .append(p_M_Product_Category_ID)
                        .append(" AND pca.C_AcctSchema_ID=")
        ...
        StringBuilder msgreturn =
                new StringBuilder("@Created@=").append(created).append(", @Updated@=").append(updated);

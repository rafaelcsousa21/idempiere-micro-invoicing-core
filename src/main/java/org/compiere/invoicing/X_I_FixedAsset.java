...
public class X_I_FixedAsset extends BasePOName implements I_I_FixedAsset, I_Persistent {
  ...
  public void setC_City_ID(int C_City_ID) {
    if (C_City_ID < 1) set_Value(COLUMNNAME_C_City_ID, null);
    else set_Value(COLUMNNAME_C_City_ID, Integer.valueOf(C_City_ID));
  }
  ...
  public void setI_FixedAsset_ID(int I_FixedAsset_ID) {
    if (I_FixedAsset_ID < 1) set_ValueNoCheck(COLUMNNAME_I_FixedAsset_ID, null);
    else set_ValueNoCheck(COLUMNNAME_I_FixedAsset_ID, Integer.valueOf(I_FixedAsset_ID));
  }

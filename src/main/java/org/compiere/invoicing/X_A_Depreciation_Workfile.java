...
public class X_A_Depreciation_Workfile extends PO
  ...
  public void setA_Depreciation_Workfile_ID(int A_Depreciation_Workfile_ID) {
    if (A_Depreciation_Workfile_ID < 1)
      ...
      set_ValueNoCheck(
          COLUMNNAME_A_Depreciation_Workfile_ID, Integer.valueOf(A_Depreciation_Workfile_ID));
  }
  ...
  public void setA_FundingMode_ID(int A_FundingMode_ID) {
    if (A_FundingMode_ID < 1) set_Value(COLUMNNAME_A_FundingMode_ID, null);
    else set_Value(COLUMNNAME_A_FundingMode_ID, Integer.valueOf(A_FundingMode_ID));
  }

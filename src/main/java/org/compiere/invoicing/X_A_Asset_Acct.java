...
public class X_A_Asset_Acct extends PO implements I_A_Asset_Acct, I_Persistent {
  ...
  public void setA_Asset_Acct_ID(int A_Asset_Acct_ID) {
    if (A_Asset_Acct_ID < 1) set_ValueNoCheck(COLUMNNAME_A_Asset_Acct_ID, null);
    else set_ValueNoCheck(COLUMNNAME_A_Asset_Acct_ID, Integer.valueOf(A_Asset_Acct_ID));
  }
  ...
  public void setA_Asset_Spread_ID(int A_Asset_Spread_ID) {
    if (A_Asset_Spread_ID < 1) set_Value(COLUMNNAME_A_Asset_Spread_ID, null);
    else set_Value(COLUMNNAME_A_Asset_Spread_ID, Integer.valueOf(A_Asset_Spread_ID));
  }

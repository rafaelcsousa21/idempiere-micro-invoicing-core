...
public class MInOutLineMA extends X_M_InOutLineMA {
  ...
  public static MInOutLineMA[] get(Properties ctx, int M_InOutLine_ID, String trxName) {
    Query query =
        MTable.get(ctx, MInOutLineMA.Table_Name)
  ...
  public static int deleteInOutLineMA(int M_InOutLine_ID, String trxName) {
    ...
    return executeUpdate(sql, M_InOutLine_ID, trxName);
  } //	deleteInOutLineMA
      ...
      if (M_AttributeSetInstance_ID > 0) {
        DateMaterialPolicy =
            MStorageOnHand.getDateMaterialPolicy(
                parent.getM_Product_ID(), M_AttributeSetInstance_ID, parent.get_TrxName());
      }
  ...
  public static MInOutLineMA addOrCreate(
    ...
    MInOutLineMA po =
        query
            .setParameters(line.getM_InOutLine_ID(), M_AttributeSetInstance_ID, DateMaterialPolicy)
            .first();
    if (po == null)
      po =
          new MInOutLineMA(
  ...
  public static BigDecimal getManualQty(int M_InOutLine_ID, String trxName) {
    ...
    BigDecimal totalQty = getSQLValueBD(trxName, sql, M_InOutLine_ID);
  ...
  protected boolean beforeSave(boolean newRecord) {
    ...
    if (!newRecord && is_ValueChanged(I_M_InOutLineMA.COLUMNNAME_M_AttributeSetInstance_ID)) {
      ...
      if (getMAttributeSetInstance_ID() > 0) {
        dateMPolicy =
            MStorageOnHand.getDateMaterialPolicy(
                line.getM_Product_ID(), getMAttributeSetInstance_ID(), get_TrxName());
      }

...
public class X_C_BankStatementLoader extends BasePOName
  ...
  public void setC_BankStatementLoader_ID(int C_BankStatementLoader_ID) {
    if (C_BankStatementLoader_ID < 1) set_ValueNoCheck(COLUMNNAME_C_BankStatementLoader_ID, null);
    else
      set_ValueNoCheck(
          COLUMNNAME_C_BankStatementLoader_ID, Integer.valueOf(C_BankStatementLoader_ID));
  }

...
public class ProductCost {
     ...
     */
    public MAccount getAccount(int AcctType, AccountingSchema as) {
        ...
        if (m_M_Product_ID == 0) return getAccountDefault(AcctType, as);
     ...
     * @return Requested Product Account
     */
    public MAccount getAccountDefault(int AcctType, AccountingSchema as) {
        if (AcctType < ACCTTYPE_P_Revenue || AcctType > ACCTTYPE_P_LandedCostClearing) return null;
    ...
    /**
     * ************************************************************************ Get Total Costs
     * (amt*qty) in Accounting Schema Currency
     *
     * @param as             accounting schema
  ...
  /*private BigDecimal getPOCost (MAcctSchema as)
  {
    ...
    public String toString() {
        ...
        sb.append("M_Product_ID=")
                ...
                .append(m_M_AttributeSetInstance_ID)
                .append(",Qty=")
                .append(m_qty)
                .append("]");
        return sb.toString();

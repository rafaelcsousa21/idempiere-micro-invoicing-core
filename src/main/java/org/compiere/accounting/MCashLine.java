...
public class MCashLine extends X_C_CashLine implements IDocLine {
  ...
  public void setInvoice(MInvoice invoice) {
    ...
    setCashType(X_C_CashLine.CASHTYPE_Invoice);
    ...
    if (MDocType.DOCBASETYPE_APInvoice.equals(dt.getDocBaseType())
        || MDocType.DOCBASETYPE_ARCreditMemo.equals(dt.getDocBaseType())) amt = amt.negate();
    setAmount(amt);
    //
    setDiscountAmt(Env.ZERO);
    setWriteOffAmt(Env.ZERO);
  ...
  public MCashLine createReversal() {
    ...
    if (getDiscountAmt() == null) setDiscountAmt(Env.ZERO);
    else reversal.setDiscountAmt(getDiscountAmt().negate());
    if (getWriteOffAmt() == null) setWriteOffAmt(Env.ZERO);
    else reversal.setWriteOffAmt(getWriteOffAmt().negate());

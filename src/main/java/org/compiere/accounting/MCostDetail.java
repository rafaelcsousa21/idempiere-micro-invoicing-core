...
public class MCostDetail extends X_M_CostDetail {
  ...
  public static boolean createOrder(
    ...
    MCostDetail cd =
        get(
            as.getCtx(),
            "C_OrderLine_ID=? AND Coalesce(M_CostElement_ID,0)=" + M_CostElement_ID,
            C_OrderLine_ID,
   ...
   * @return true if no error
   */
  public static boolean createMovement(
      MAcctSchema as,
      int AD_Org_ID,
      int M_Product_ID,
      int M_AttributeSetInstance_ID,
      ...
      String trxName) {
    StringBuilder msget =
        new StringBuilder("M_MovementLine_ID=? AND IsSOTrx=")
            .append((from ? "'Y'" : "'N'"))
            .append(" AND Coalesce(M_CostElement_ID,0)=")
   ...
   * @return true if no error
   */
  public static boolean createProduction(
      MAcctSchema as,
      int AD_Org_ID,
      int M_Product_ID,
      int M_AttributeSetInstance_ID,
    ...
    MCostDetail cd =
        get(
            as.getCtx(),
            "M_ProductionLine_ID=? AND Coalesce(M_CostElement_ID,0)=" + M_CostElement_ID,
            M_ProductionLine_ID,
            M_AttributeSetInstance_ID,
            as.getC_AcctSchema_ID(),
            trxName);
   ...
   * @return true if no error
   */
  public static boolean createMatchInvoice(
      MAcctSchema as,
      int AD_Org_ID,
      int M_Product_ID,
      int M_AttributeSetInstance_ID,
    ...
    MCostDetail cd =
        get(
            as.getCtx(),
            "M_MatchInv_ID=? AND Coalesce(M_CostElement_ID,0)=" + M_CostElement_ID,
            M_MatchInv_ID,
            M_AttributeSetInstance_ID,
            as.getC_AcctSchema_ID(),
            trxName);
   ...
   * @return true if no error
   */
  public static boolean createProjectIssue(
      MAcctSchema as,
      int AD_Org_ID,
      int M_Product_ID,
      int M_AttributeSetInstance_ID,
    ...
    MCostDetail cd =
        get(
            as.getCtx(),
            "C_ProjectIssue_ID=? AND Coalesce(M_CostElement_ID,0)=" + M_CostElement_ID,
            C_ProjectIssue_ID,
            M_AttributeSetInstance_ID,
            as.getC_AcctSchema_ID(),
            trxName);
  ...
  public static MCostDetail get(
      Properties ctx, String whereClause, int ID, int M_AttributeSetInstance_ID, String trxName) {
    ...
    try {
      ...
      if (rs.next()) retValue = new MCostDetail(ctx, rs, trxName);
    } catch (Exception e) {
  ...
  public static MCostDetail get(
    ...
    MCostDetail retValue =
        new Query(ctx, I_M_CostDetail.Table_Name, localWhereClause.toString(), trxName)
   ...
   * @return true if no error
   */
  public static boolean processProduct(I_M_Product product, String trxName) {

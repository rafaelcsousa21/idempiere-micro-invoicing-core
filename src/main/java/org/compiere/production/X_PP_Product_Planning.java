...
public class X_PP_Product_Planning extends PO implements I_PP_Product_Planning {
    ...
    public void setDD_NetworkDistribution_ID(int DD_NetworkDistribution_ID) {
        if (DD_NetworkDistribution_ID < 1) set_Value(COLUMNNAME_DD_NetworkDistribution_ID, null);
        else
    ...
    public void setPP_Product_Planning_ID(int PP_Product_Planning_ID) {
        if (PP_Product_Planning_ID < 1) set_ValueNoCheck(COLUMNNAME_PP_Product_Planning_ID, null);
        else
    ...
    public void setS_Resource_ID(int S_Resource_ID) {
        ...
        else set_ValueNoCheck(COLUMNNAME_S_Resource_ID, S_Resource_ID);
    }

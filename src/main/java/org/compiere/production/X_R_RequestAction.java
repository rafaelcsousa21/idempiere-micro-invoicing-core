...
public class X_R_RequestAction extends PO implements I_R_RequestAction, I_Persistent {
  ...
  public void setM_RMA_ID(int M_RMA_ID) {
    if (M_RMA_ID < 1) set_ValueNoCheck(COLUMNNAME_M_RMA_ID, null);
    else set_ValueNoCheck(COLUMNNAME_M_RMA_ID, Integer.valueOf(M_RMA_ID));
  }
  ...
  public void setR_RequestAction_ID(int R_RequestAction_ID) {
    if (R_RequestAction_ID < 1) set_ValueNoCheck(COLUMNNAME_R_RequestAction_ID, null);
    else set_ValueNoCheck(COLUMNNAME_R_RequestAction_ID, Integer.valueOf(R_RequestAction_ID));
  }
  ...
  public void setSalesRep_ID(int SalesRep_ID) {
    if (SalesRep_ID < 1) set_ValueNoCheck(COLUMNNAME_SalesRep_ID, null);
    else set_ValueNoCheck(COLUMNNAME_SalesRep_ID, Integer.valueOf(SalesRep_ID));
  }

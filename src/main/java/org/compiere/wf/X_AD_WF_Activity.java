...
public class X_AD_WF_Activity extends PO implements I_AD_WF_Activity {
    ...
    public void setWorkflowProcessId(int AD_WF_Process_ID) {
        if (AD_WF_Process_ID < 1) setValueNoCheck(COLUMNNAME_AD_WF_Process_ID, null);
        else setValueNoCheck(COLUMNNAME_AD_WF_Process_ID, Integer.valueOf(AD_WF_Process_ID));
    }
    ...
    public void setEndWaitTime(Timestamp EndWaitTime) {
        setValue(COLUMNNAME_EndWaitTime, EndWaitTime);
    }
